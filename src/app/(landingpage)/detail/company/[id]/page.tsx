                ...
                <div className="inline-flex items-center gap-10 mt-6">
                  <div className="inline-flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">10 Maret 2022</div>
                    </div>
                  </div>
                  <div className="inline-flex items-center gap-3">
                    <div>
          ...
          <div className="w-3/4">
            <div className="mb-16">
              ...
              <div className="text-muted-foreground">
                ...
                voluptates velit perferendis quos ipsum minima iusto nemo
                tempora deleniti. Asperiores accusamus, est beatae repudiandae
                molestias distinctio minus deleniti reiciendis fuga.
              </div>
            </div>
            <div>
            ...
            <div className="grid grid-cols-5 gap-5 mt-5">
              <div className="border border-border px-3 py-5">
                ...
                <div className="text-center my-4">
                  <div className="font-semibold text-sm">Legino</div>
                  <div className="text-gray-500 text-xs">Front-end Lead</div>
                </div>
